...
Set-ApplicationParticulars `
  ...
  -AppCopyright 'Copyright © 1984-2018 Adobe Systems Incorporated and its licensors' `
  -License Proprietary `
  -LicenseURI 'https://www.adobe.com/products/eulas/pdfs/Reader10_combined-20100625_1419.pdf' `
  -Tags @('adobereader','adobe','acrobat','reader','DC','pdf','MUI') `
  -Description 'View, print, sign, and annotate PDF files.' `
...
Set-InstallerLanguages `
  ...
  -UpdateURI x https://adobe.com/reader/`
  -UpdateRegex '(+.*/S)' `
