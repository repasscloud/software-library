...
$appDL = '/Users/danijeljames/Developer/software-matrix/.public/'
...
function Invoke-PullDownThatFile() {  
  ...
  Invoke-Webrequest -Uri $UrlX -OutFile $('/Users/danijeljames/Developer/software-matrix/.public/' + (Split-Path -Path $UrlX -Leaf))
}

'' | ForEach-Object { Invoke-PullDownThatFile -URI $_ }
